#ifndef EXCELLENTEAM_ELLA_C_DNA_CHANAMI_SHARED_PTR_H
#define EXCELLENTEAM_ELLA_C_DNA_CHANAMI_SHARED_PTR_H
...
#endif //EXCELLENTEAM_ELLA_C_DNA_CHANAMI_SHARED_PTR_H
